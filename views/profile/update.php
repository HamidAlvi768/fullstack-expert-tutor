    ...
    <div class="profile-main-content">
        <!-- <div class="container"> -->
            ...
            <div class="profile-form-container">
                <?php $form = ActiveForm::begin(['options' => ['enctype' => 'multipart/form-data', 'method' => 'POST', 'class' => 'profile-form-container']]); ?>

                <!-- Profile Photo Section -->
                <div class="profile-photo-upload">
                    <div class="profile-photo-placeholder">
                        <img src="<?= $model->avatar_url ? $model->avatar_url : Yii::getAlias('@web') . '/assets/images/profile-placeholder.jpg' ?>" alt="Upload Photo" id="profile-preview">
                    </div>
                    <?= $form->field($model, 'avatarFile')->fileInput(['id' => 'photo-upload', 'accept' => 'image/*', 'hidden' => true])->label(false) ?>
                    <label for="photo-upload" class="profile-upload-label">Upload Your Photo</label>
                </div>

                <!-- Hidden field to retain old image if not updated -->
                <?= Html::hiddenInput('oldAvatar', $model->avatar_url) ?>
